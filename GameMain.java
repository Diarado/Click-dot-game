...
public class GameMain {
    ...
    private static void createAndShowGUI() {
        ...
        menuBar.add(menu);
        JMenuItem menuItem = new JMenuItem("Save score");
        menu.add(menuItem);
    ...
    private static void addSliderLabels(JSlider slider, String minLabel,
        ...
        JLabel min = new JLabel(minLabel);
        JLabel max = new JLabel(maxLabel);
        labels.put(slider.getMinimum(), min);
        labels.put(slider.getMaximum(), max);
    ...
    private static JComponent makeSliderPanel(JSlider slider, String title) {
        ...
        JLabel SliderLabel = new JLabel(title, SwingConstants.CENTER);
        SliderLabel.setFont(SliderLabel.getFont().deriveFont(16.0f));
        p.add(SliderLabel, BorderLayout.NORTH);
        p.add(slider);
        return p;
    }
